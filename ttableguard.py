...
class CTableGuard():
    ...
    def __query_metadata(self): #+**
        ...
        try:
            ...
            l_query = "select column_name, data_type, character_maximum_length \
    ...
    def set_query_for_update(self, p_query, p_id): #+++
        ...
        assert p_query is not None, "Assert: [CTableGuard.set_query_for_update]: \
    ...
    def set_query_for_insert(self, p_query):
        ...
        assert p_query is not None, "Assert: [CTableGuard.set_query_for_insert]: \
            No <p_query> parameter specified!"
    ...
    def set_field_list(self, p_field_list): #++
        ...
        assert p_field_list is not None, "Assert: [CTableGuard.set_field_list]: \
    ...
    def get_field_value(self, p_field_idx):
        ...
        assert p_field_idx is not None, "Assert: [CTableGuard.get_field_value]: \
    ...
    def load_line_edit(self, p_line_edit, p_field_idx): #+++
        ...
        assert p_line_edit is not None, "Assert: [CTableGuard.load_line_edit]: \
    ...
    def load_date_edit(self, p_date_edit, p_field_idx): #+++
        ...
        assert p_date_edit is not None, "Assert: [CTableGuard.load_date_edit]: \
            No <p_date_edit> parameter specified!"
        assert p_field_idx is not None, "Assert: [CTableGuard.load_date_edit]: \
            No <p_field_idx> parameter specified!"
